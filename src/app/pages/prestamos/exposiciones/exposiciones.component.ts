...
import {AddEditOrganizacionComponent} from '../organizaciones/add-edit-organizacion/add-edit-organizacion.component';
import {AlertDeletePiezaComponent} from '../../catalogo/alert-delete-pieza/alert-delete-pieza.component';
import {AddEditExposicionComponent} from './add-edit-exposicion/add-edit-exposicion.component';
...
export class ExposicionesComponent implements OnInit {
  ...
  openModal(type, info?) {
    let dialogRef;
    if (type === 'new') {
      dialogRef = this.dialog.open(AddEditExposicionComponent, {
        width: '40vw',
        data: {
          type: 'new'
        }
