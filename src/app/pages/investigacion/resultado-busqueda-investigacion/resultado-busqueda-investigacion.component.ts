...
@Component({
  selector: 'app-resultado-busqueda-investigacion',
  templateUrl: './resultado-busqueda-investigacion.component.html',
  styleUrls: ['./resultado-busqueda-investigacion.component.scss']
})
export class ResultadoBusquedaInvestigacionComponent implements OnInit {
